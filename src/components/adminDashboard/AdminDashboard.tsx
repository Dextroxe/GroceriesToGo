...
export function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [isUpdateModalOpen, isEditModalOpen]);
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                              <div className="flex justify-end space-x-2">
                                ...
                                <button
                                  ...
                                  className="inline-flex items-center px-3 py-1.5 border border-gray-300 text-sm leading-5 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                >
                                  Update Product
                                </button>
                              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          id="tax_rate"
                          name="tax_rate"
                          value={editedProduct?.tax_rate || 0}
                          onChange={handleEditInputChange}
                          step="0.01"
                          min="0"
                          className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          id="reorder_stock_level"
                          name="reorder_stock_level"
                          value={editedProduct?.reorder_stock_level || 0}
                          onChange={handleEditInputChange}
                          min="0"
                          className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          id="lifespan"
                          name="lifespan"
                          value={editedProduct?.lifespan || 0}
                          onChange={handleEditInputChange}
                          min="0"
                          className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                        />
